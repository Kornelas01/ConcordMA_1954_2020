...
one_to_one$scientificName <-  str_replace(one_to_one$scientificName, "Raphanus raphanistrum subsp. sativus", "Raphanus sativus")
one_to_one$scientificName <-  str_replace(one_to_one$scientificName, "Ampelopsis glandulosa var. brevipedunculata", "Ampelopsis brevipedunculata")
one_to_one$scientificName <-  str_replace(one_to_one$scientificName, "Nabalus autumnalis", "Prenanthes autumnalis")
```
